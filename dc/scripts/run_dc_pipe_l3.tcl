# Pipelined + L=3 synthesis script
# This is the most timing-focused version, so retime stays on here too.

set DESIGN fir_pipe_parallel_l3

analyze -format sverilog {rtl/fir_pipe_parallel_l3.sv}
elaborate $DESIGN
