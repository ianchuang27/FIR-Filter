# L=2 synthesis script
# Uses compile_ultra to give the parallel version a better timing shot.

set DESIGN fir_parallel_l2

analyze -format sverilog {rtl/fir_parallel_l2.sv}
elaborate $DESIGN
